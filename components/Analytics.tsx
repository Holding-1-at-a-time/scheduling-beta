...
export function Analytics({ tenantId }: AnalyticsProps) {
    const analyticsData = useQuery(api.analytics.getAnalyticsData, { tenantId });
    const detailedAnalytics = useQuery(api.analytics.getBusinessMetrics, { tenantId });
